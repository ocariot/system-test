...
describe('Routes: users.educators', () => {
    ...
    describe('GET /users/educators/:educator_id', () => {
        context('when get a unique educator in database successfully', () => {
            ...
            it('educators.get_id003: should return status code 200 and the educator data obtained by himself', () => {
            ...
            describe('when admin gets a unique educator who has a children group associated with him', () => {
                before(async () => {
                    const body = {
                ...
                it('educators.get_id004: should return status code 200 and a educator, without the children group data', () => {
