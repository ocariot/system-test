    ...
    describe('GET /robot-result/mission/:child.id', () => {
        ...
        afterEach(async () => {
            try {
                ...
                console.log('Failure in after from robot-result.mission.get test: ', err.message)
            }
        })
        ...
        context('when the Robot-Result not found', () => {
            ...
            it('robot-result.mission.get007: should return an error, because Robot-Result.id is invalid', async () => {
            ...
            it('robot-result.mission.get008: should return an error, because Robot-Result not found', async () => {
        ...
        describe('when the child has been deleted', () => {
            ...
            it('robot-result.mission.get014: should return an error, because Robot-Result not found', async () => {
