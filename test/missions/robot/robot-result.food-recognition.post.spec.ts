...
describe('Routes: Robot', () => {
    ...
    describe('POST /robot-result/food-recognition', () => {
        ...
        context('when the user posting a Food-Recognition successfully', () => {
            ...
            it.only('food-recognition.post001: should return status code 200 and the saved Food-Recognition by the educator user', async () => {
            ...
            context('when a validation error occurs', () => {
                ...
                beforeEach(async () => {
                    try {
                        incorrectFoodRecognition = defaultFoodRecognition.fromJSON(defaultFoodRecognition)
                    } catch (err) {
