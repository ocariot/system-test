            ...
            it('institutions.get_all001: should return status code 200 and a list of institutions for admin user', () => {
                ...
                return request(URI)
                    ...
                    .then(res => {
                        ...
                        expect(res.body[1].latitude).to.eql(defaultInstitution.latitude!.toString())
                        expect(res.body[1].longitude).to.eql(defaultInstitution.longitude!.toString())
                    })
            })
            ...
            it('institutions.get_all006: should return status code 200 and a list with two institutions in descending order by type', () => {
                ...
                return request(URI)
                    ...
                    .then(res => {
                        ...
                        expect(res.body[0].latitude).to.eql(defaultInstitution.latitude!.toString())
                        expect(res.body[0].longitude).to.eql(defaultInstitution.longitude!.toString())
