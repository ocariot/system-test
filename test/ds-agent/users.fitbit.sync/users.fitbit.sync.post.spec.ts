...
describe('Routes: users.fitbit.sync', () => {
    ...
    describe('POST ​/v1​/users​/:child_id/fitbit​/sync', () => {

        context('when request user data synchronization on Fitbit platform with OCARIoT platform..', () => {

            it('users.fitbit.sync.post001: should return status code 201 when request data sync', () => {

                return request(URI)
                    .post(`/users/${defaultChild.id}/fitbit/sync`)
