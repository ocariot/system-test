...
describe('Routes: users.children.physicalactivities.logs', () => {
    ...
    describe('GET /children/:child_id/physicalactivities/logs/date/:date_start/:date_end', () => {
        ...
        context('when the user get all logs for each resource of the child successfully', () => {
            ...
            it('logs.get_all001: should return status code 200 and the all logs registered for each resource for admin user', () => {
                ...
                return request(URI)
                    .get(`/children/${defaultChild.id}/physicalactivities/logs/date/${LOG_DATE_START}/${LOG_DATE_END}`)
            ...
            describe('when the log for specified dates not found', () => {
                ...
                it('logs.get_all007: should return status code 200 and an empty array', () => {
                    ...
                    return request(URI)
                        .get(`/children/${defaultChild.id}/physicalactivities/logs/date/${date_star}/${date_ed}`)
                        .set('Authorization', 'Bearer '.concat(accessTokenAdmin))
                        .set('Content-Type', 'application/json')
                        .expect(200)
                        .then(res => {
        ...
        describe('when a validation error occurs', () => {
            ...
            it('logs.get_all008: should return status code 400 and info message from invalid year in date', () => {
                ...
                return request(URI)
                    .get(`/children/${defaultChild.id}/physicalactivities/logs/date/${wrongYear}/${date_end}`)
                    .set('Authorization', 'Bearer '.concat(accessTokenAdmin))
                    .set('Content-Type', 'application/json')
                    .expect(400)
                    .then(err => {
            ...
            it('logs.get_all009: should return status code 400 and info message from invalid month in date', () => {
                ...
                return request(URI)
                    .get(`/children/${defaultChild.id}/physicalactivities/logs/date/${date_start}/${wrongMonth}`)
                    .set('Authorization', 'Bearer '.concat(accessTokenChild))
                    .set('Content-Type', 'application/json')
                    .expect(400)
                    .then(err => {
            ...
            it('logs.get_all010: should return status code 400 and info message from from invalid day in date', () => {
                ...
                return request(URI)
                    .get(`/children/${defaultChild.id}/physicalactivities/logs/date/${wrongDay}/${date_end}`)
                    .set('Authorization', 'Bearer '.concat(accessTokenEducator))
                    .set('Content-Type', 'application/json')
                    .expect(400)
                    .then(err => {
            ...
            it.only('logs.get_all011: should return status code 400 and info message from invalid child_id', () => {
                ...
                return request(URI)
                    .get(`/children/${acc.INVALID_ID}/physicalactivities/logs/date/${LOG_DATE_START}/${LOG_DATE_END}`)
                    .set('Authorization', 'Bearer '.concat(accessTokenEducator))
                    .set('Content-Type', 'application/json')
                    .expect(400)
                    .then(err => {
            ...
            it('logs.get_all012: should return status code 400 and info message from validation error, because child not exist', () => {
                ...
                return request(URI)
                    .get(`/children/${acc.NON_EXISTENT_ID}/physicalactivities/logs/date/${LOG_DATE_START}/${LOG_DATE_END}`)
                    .set('Authorization', 'Bearer '.concat(accessTokenEducator))
                    .set('Content-Type', 'application/json')
                    .expect(400)
                    .then(err => {
