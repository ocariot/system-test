            ...
            it('physical.activities.post001: should return status code 201 and the saved PhysicalActivity by the child user', () => {
                ...
                return request(URI)
                    ...
                    .then(res => {
                        ...
                        expect(res.body.start_time).to.eql(physicalActivity.start_time!.toISOString().split('.')[0])
                        expect(res.body.end_time).to.eql(physicalActivity.end_time!.toISOString().split('.')[0])
                        ...
                        return request(URI)
                            ...
                            .then(res => {
                                for (let i = 0; i < res.body.success.length; i++) {
                                    ...
                                    expect(res.body.success[i].item.start_time).to.eql(correctActivities[i].start_time!.toISOString().split('.')[0])
                                    expect(res.body.success[i].item.end_time).to.eql(correctActivities[i].end_time!.toISOString().split('.')[0])
                        ...
                        return request(URI)
                            ...
                            .then(res => {
                                for (let i = 0; i < res.body.error.length; i++) {
                                    ...
                                    expect(res.body.error[i].item.start_time).to.eql(correctActivities[i].start_time!.toISOString().split('.')[0])
                                    expect(res.body.error[i].item.end_time).to.eql(correctActivities[i].end_time!.toISOString().split('.')[0])
                    ...
                    it('physical.activities.post047: should return status code 207, and return a response with description of sucess and error in each activity', () => {
                        ...
                        return request(URI)
                            ...
                            .then(res => {
                                ...
                                expect(res.body.success[0].item.start_time).to.eql(mixedActivities[0].start_time!.toISOString().split('.')[0])
                                expect(res.body.success[0].item.end_time).to.eql(mixedActivities[0].end_time!.toISOString().split('.')[0])
                        ...
                        return request(URI)
                            ...
                            .then(res => {
                                ...
                                for (let i = 0; i < wrongActivities.length; i++) {
                                    ...
                                    expect(res.body.error[0].item.start_time).to.eql(wrongActivities[0].start_time!.toISOString().split('.')[0])
                                    expect(res.body.error[0].item.end_time).to.eql(wrongActivities[0].end_time!.toISOString().split('.')[0])
            ...
            it('physical.activities.post005: should return status code 201 and the saved PhysicalActivity without steps', () => {
                ...
                return request(URI)
                    ...
                    .then(res => {
                        ...
                        expect(res.body.start_time).to.eql(swimActivity.start_time!.toISOString().split('.')[0])
                        expect(res.body.end_time).to.eql(swimActivity.end_time!.toISOString().split('.')[0])
            ...
            it('physical.activities.post006: should return status code 201 and the saved PhysicalActivity without levels', () => {
                ...
                return request(URI)
                    ...
                    .then(res => {
                        ...
                        expect(res.body.start_time).to.eql(walkActivity.start_time!.toISOString().split('.')[0])
                        expect(res.body.end_time).to.eql(walkActivity.end_time!.toISOString().split('.')[0])
