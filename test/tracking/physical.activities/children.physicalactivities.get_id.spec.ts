            ...
            it('physical.activities.get_id001: should return status code 200 and and the specific physical activity for admin user', () => {
                ...
                return request(URI)
                    ...
                    .then(res => {
                        ...
                        expect(res.body.start_time).to.eql(defaultActivity.start_time!.toISOString().split('.')[0])
                        expect(res.body.end_time).to.eql(defaultActivity.end_time!.toISOString().split('.')[0])
