            ...
            it('sleep.get_id001: should return status code 200 and and the specific sleep for admin user', () => {
                ...
                return request(URI)
                    ...
                    .then(res => {
                        ...
                        expect(res.body).to.have.property('start_time', defaultSleep.start_time!.toISOString().split('.')[0])
                        expect(res.body).to.have.property('end_time', defaultSleep.end_time!.toISOString().split('.')[0])
