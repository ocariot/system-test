...
//     })
//
//     describe('PATCH /children/:child_id/sleep/:sleep_id', () => {
//
//         beforeEach(async () => {
//             try {
//
...
//
//                 return request(URI)
//                     .patch(`/children/${defaultChild.id}/sleep/${otherSleep.id}`)
//                     .send(body)
//                     .set('Content-Type', 'application/json')
//                     .set('Authorization', 'Bearer '.concat(accessTokenEducator))
//                     .expect(409)
...
//                 return request(URI)
//                     .patch(`/children/${non_existent_child_id}/sleep/${sleep.id}`)
//                     .send(body)
//                     .set('Content-Type', 'application/json')
//                     .set('Authorization', 'Bearer '.concat(accessTokenEducator))
//                     .expect(400)
...
//
//                 return request(URI)
//                     .patch(`/children/${defaultChild.id}/sleep/${non_existent_sleep_id}`)
//                     .send(body)
//                     .set('Content-Type', 'application/json')
//                     .set('Authorization', 'Bearer '.concat(accessTokenEducator))
//                     .expect(404)
